# -*- encoding: utf-8 -*-
require File.expand_path('../lib/rails3_serve_static_assets/version', __FILE__)
...
Gem::Specification.new do |gem|
  ...
  gem.homepage      = "https://github.com/heroku/rails3_serve_static_assets"

  gem.executables   = `git ls-files -- bin/*`.split("\n").map{ |f| File.basename(f) }
  gem.files         = `git ls-files`.split("\n")
  gem.test_files    = `git ls-files -- {test,spec,features}/*`.split("\n")
  gem.name          = "rails3_serve_static_assets"
  gem.require_paths = ["lib"]
  gem.version       = Rails3ServeStaticAssets::VERSION
end
